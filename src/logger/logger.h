...
#define set_attributes(b, i, u, r) \
    set_b(b) << set_i(i) << set_u(u) << set_r(r) << set_colors(fg_c, bg_c)
...
#define set_underline(u) \
    default_attributes << set_attributes(is_b, is_i, u, is_r)
