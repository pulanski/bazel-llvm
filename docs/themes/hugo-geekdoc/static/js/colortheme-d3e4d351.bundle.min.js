            ...
            1860: function (t) {
                ...
                (e = this),
                    ...
                    (r = {
                        ...
                        storeAPI: {
                            ...
                            namespace: function (t, e, n) {
                                if (((n = n || this._delim || r.nsdelim), !t))
                                    return this._ns
                                        ? this._ns.substring(
                                              0,
                    ...
                    "function" == typeof n && void 0 !== n.amd
                        ...
                        : t.exports
                        ? (t.exports = i)
                        : (e.store && (r.conflict = e.store), (e.store = i));
            },
            6914: function (t, e, n) {
                "use strict";
                n.r(e),
        ...
        (function () {
            ...
            function s(n = !0) {
                ...
                let s = t.namespace(r),
                    ...
                    a = e.includes(s.get("color-theme"))
                        ? s.get("color-theme")
                        : i;
                o.setAttribute("class", "color-toggle-" + a),
                    a === i
                        ? o.removeAttribute("color-theme")
                        : o.setAttribute("color-theme", a),
                    n || location.reload();
            }
            s(),
                document.addEventListener("DOMContentLoaded", (n) => {
                    document.getElementById("gdoc-color-theme").onclick =
                        function () {
                            let n = t.namespace(r),
                                o = n.get("color-theme") || i,
                                a = (function (t = [], e) {
                                    let n = t.indexOf(e),
                                        r = 0;
                                    return n < t.length - 1 && (r = n + 1), r;
                                })(e, o);
                            n.set("color-theme", e[a]), s(!1);
                        };
                });
        })();
})();
