!(function () {
    var t,
        ...
        n = {
            1860: function (t) {
                !(function (e, n) {
                    var r = {
                            ...
                            fn: function (t, e) {
                                for (var n in ((r.storeAPI[t] = e), r.apis))
                                    r.apis[n][t] = e;
                            },
                            get: function (t, e) {
                                return t.getItem(e);
                            ...
                            storeAPI: {
                                ...
                                namespace: function (t, e, n) {
                                    if (
                                        ((n = n || this._delim || r.nsdelim),
                                        !t)
                                    )
                                        return this._ns
                                            ? this._ns.substring(
                                                  0,
                                                  this._ns.length - n.length
                                              )
                                            : "";
                                    var i = t,
                                        a = this[i];
                                    ...
                                    return (
                                        t
                                            ? ((this._real = this._area),
                                              (this._area = r.storage("fake")))
                                            : !1 === t &&
                                              (this._area =
                                                  this._real || this._area),
                                        "fake" === this._area.name
                                    );
                                },
                                toString: function () {
                                    return (
                                ...
                                each: function (t, e) {
                                    for (
                                        var n = 0, i = r.length(this._area);
                                        n < i;
                                        n++
                                    ) {
                                        var a = this._out(r.key(this._area, n));
                                        if (
                                            void 0 !== a &&
                                            !1 ===
                                                t.call(this, a, this.get(a), e)
                                        )
                                            break;
                                ...
                                clearAll: function () {
                                    var t = this._area;
                                    for (var e in r.areas)
                                        r.areas.hasOwnProperty(e) &&
                                            ((this._area = r.areas[e]),
                                            this.clear());
                            ...
                            storageAPI: {
                                ...
                                removeItem: function (t) {
                                    this.has(t) &&
                                        (delete this.items[t], this.length--);
                                },
                                getItem: function (t) {
                    ...
                    (i.local = i),
                        ...
                        i.area("page", r.storage("page")),
                        "function" == typeof n && void 0 !== n.amd
                            ? n("store2", [], function () {
                                  return i;
                              })
                            : t.exports
                            ? (t.exports = i)
                            : (e.store && (r.conflict = e.store),
                              (e.store = i));
            ...
            6914: function (t, e, n) {
                ...
                n.r(e),
                    n.d(e, {
                        COLOR_THEME_AUTO: function () {
                            return a;
                        },
                        COLOR_THEME_DARK: function () {
                            return r;
                        },
                        COLOR_THEME_LIGHT: function () {
                            return i;
                        },
                        THEME: function () {
                            return o;
                        },
                        TOGGLE_COLOR_THEMES: function () {
                            return s;
                        },
                    });
                const r = "dark",
    ...
    function i(t) {
        ...
        return (
            n[t].call(a.exports, a, a.exports, i), (a.loaded = !0), a.exports
        );
    }
    (i.m = n),
        (i.d = function (t, e) {
        ...
        (i.l = function (n, r, a, o) {
            if (t[n]) t[n].push(r);
                ...
                if (void 0 !== a)
                    for (
                        ...
                        if (
                            ...
                            f.getAttribute("data-webpack") == e + a
                        ) {
                            s = f;
                            break;
                        }
                ...
                s ||
                    ...
                    s.setAttribute("data-webpack", e + a),
                    (s.src = n)),
                    (t[n] = [r]);
                var l = function (e, r) {
        ...
        (function () {
            ...
            var e = function (e, n) {
                    ...
                    for (e && e(n); c < o.length; c++)
                        (a = o[c]), i.o(t, a) && t[a] && t[a][0](), (t[a] = 0);
                },
                n = (self.webpackChunkgeekdoc = self.webpackChunkgeekdoc || []);
        ...
        (function () {
            ...
            document.addEventListener("DOMContentLoaded", function (a) {
                let o = t.namespace(n).get("color-theme") || r,
                    s = window.matchMedia("(prefers-color-scheme: dark)"),
                    u = !1,
                    c = "default";
                (o === e || (o === r && s.matches)) && ((u = !0), (c = "dark")),
                    Promise.all([i.e(890), i.e(748)])
                        .then(i.bind(i, 7426))
                        .then(({ default: t }) => {
                            t.initialize({
                                flowchart: { useMaxWidth: !0 },
                                theme: c,
                                themeVariables: { darkMode: u },
                            });
                        })
